  ...
  return (
    <main className='page'>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Code Obsidian. Our team is ready to answer your questions and help you with your software development needs." />
      </Helmet>
      <section>
        <div className='container'>
          ...
          <form className='animate-in flex flex-col gap-6 max-w-[600px]' onSubmit={handleSubmit}>
            ...
            <div className='form-section'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                />
                {emailErr.error && <span id="emailError" className='error'>{emailErr.msg}</span>}
              </div>
            </div>
            <div className='form-section'>
            ...
            <div className='form-section'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                />
                {messageErr.error && <span id="messageError" className='error'>{messageErr.msg}</span>}
              </div>
            </div>
